...
//
// assumes Grade::Grade(unsigned int, unsigned int)
//         Grade::scored() : unsigned int
//         Grade::total() : unsigned int
// tests Grade::operator==(Grade)
//       Grade::operator==(int)
//       operator==(int, Grade)
//
...
inline bool TestEqualsGrade(int&& scored1, int&& total1,
  ...
  const Grade kLHS(scored1, total1), kRHS(scored2, total2);
