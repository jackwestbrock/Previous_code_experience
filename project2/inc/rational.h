// Copyright 2022
#ifndef PROJECT2_INC_RATIONAL_H_
#define PROJECT2_INC_RATIONAL_H_
...
class Rational {
 public:
  ...
  //  * Does not modify calling object; const method.
  bool Equals(const Rational& right_hand_side) const;

  // operator==: see Equals(Rational) above
  bool operator==(const Rational& right_hand_side) const;
  ...
  //    used, only integer values.
  //  * Does not modify calling object; const method.
  bool Equals(int right_hand_side) const;
  ...
  //  * Does not modify calling object; const method.
  const Rational DividedBy(const Rational& right_hand_side) const;

  // operator/: see DividedBy(Rational) above.
  const Rational operator/(const Rational& right_hand_side) const;
  ...
  //  * Does not modify calling object; const method.
  const Rational DividedBy(int right_hand_side) const;

  // operator/: see DividedBy(int) above
  const Rational operator/(int right_hand_side) const;
  ...
  //    above equation.
  //  * Does not modify calling object; const method.
  const Rational Plus(const Rational& right_hand_side) const;
  ...
  //  * Does not modify calling object; const method.
  const Rational Plus(int right_hand_side) const;
...
#endif  // PROJECT2_INC_RATIONAL_H_
