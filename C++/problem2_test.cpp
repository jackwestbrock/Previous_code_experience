...
#include "problem2.h"
#include "problem2.h" // test correct header constuction
#include <cassert>
#include <iostream>
#include <sstream>
#include <string>
...
#ifdef _GLIBCXX_ALGORITHM  //TODO: remove me before giving to students
  assert(false && "Included algorithms lib. No points!");
#endif 
